...
Status: deployed and verified September 14, 2026. Runtime player memory retains changes for 180 days (up to 10,000 per league scope) and pregame forecasts/results for 2 years. News references and decisions are preserved as short records. SQL writes batch 100 records per query. Individual live player props remain blocked by paid production licensing; scrambled trials are excluded. Snap/route participation, confirmed starter depth and independently calibrated matchup effects remain future integrations until identity matching, freshness and evaluation support them.
